...
if ($_SESSION['envio'] == 1 or $_SESSION['envio'] == 2) {
...
?>
            ...
            ?>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="check-metodo" id="tarjeta1" value="<?php echo $row['id_card']; ?>" <?php if ($row['principal'] == 1) {
                                                                                                                                                echo ' checked';
                                                                                                                                            } ?>>
